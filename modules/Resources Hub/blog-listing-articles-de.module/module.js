...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Triggers
  const triggerButton = document.getElementById('blog-trigger-de');
  const triggerSuccessListing = document.getElementById('success-trigger-de');
  const triggerWebinars = document.getElementById('webinar-trigger-de');
  const triggerHomepage = document.getElementById('home-trigger-de');
  ...
  async function fetchBlogPosts(after = '') {
    let apiUrl = `https://hs-resource-blog-de.catalin-avarvarei-ext.workers.dev/${after ? `&after=${after}` : ''}`; 
  ...
  async function fetchSuccessStories() {
    try {
      const apiUrl = `https://hs-success-stories-de.catalin-avarvarei-ext.workers.dev/`; // Get the URL based on current language
  ...
  async function fetchWebinars() {
    try {
      const apiUrl = `https://hs-webinars-de.catalin-avarvarei-ext.workers.dev/`; // Get the URL based on current language
      const response = await fetch(apiUrl);
      const data = await response.json();
  ...
  async function fetchAndDisplayArticle() {
    try {
      const apiUrl = `https://hs-spotlight-article-de.catalin-avarvarei-ext.workers.dev/`; // Get the URL based on current language
      const response = await fetch(apiUrl);
      const data = await response.json();
  ...
  async function fetchCustomAds() {
    try {
      const response = await fetch(`https://hs-custom-ads-de.catalin-avarvarei-ext.workers.dev/`);
      const data = await response.json();
  ...
  async function fetchBlogPostsLimited() {
    try {
      const [tagsResponse, postsResponse, authorsMap] = await Promise.all([
        fetchTags(),
        fetch(`https://hs-resource-blog-limit-de.catalin-avarvarei-ext.workers.dev/`),
  ...
  async function fetchSuccessStoriesLimited() {
    try {
      const response = await fetch(`https://hs-success-stories-limit-de.catalin-avarvarei-ext.workers.dev/`);
      const data = await response.json();
  ...
  async function fetchWebinarsLimited() {
    try {
      const response = await fetch(`https://hs-webinars-de.catalin-avarvarei-ext.workers.dev/`);
      const data = await response.json();
