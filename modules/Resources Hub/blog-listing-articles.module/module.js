...
document.addEventListener("DOMContentLoaded", function() {  
  let selectedLanguage = "{{ module.select_language }}";
  ...
  // Triggers
  const triggerButton = document.getElementById('blog-trigger');
  const triggerSuccessListing = document.getElementById('success-trigger');
  const triggerWebinars = document.getElementById('webinar-trigger');
  const triggerHomepage = document.getElementById('home-trigger');
  ...
  async function fetchAllAuthors() {
    try {
      const response = await fetch('https://hs-blog-authors.avarvareicatalin.workers.dev/');
  ...
  async function fetchTags() {
    try {
      const response = await fetch('https://resource-hub-articles-tag.avarvareicatalin.workers.dev/');
  ...
  async function fetchBlogPosts(after = '') {
    ...
    let selectLanguage = "{{ module.select_language }}";
    let apiUrl = `https://hs-resource-hub-blog.avarvareicatalin.workers.dev/${after ? `&after=${after}` : ''}`;
  ...
  async function fetchSuccessStories(selectedLanguage) {
    try {

      let apiUrl = "https://hs-success-stories-en.catalin-avarvarei-ext.workers.dev/";
  ...
  async function fetchWebinars() {
    try {
      ...
      let apiUrl = "https://hs-webinars-en.catalin-avarvarei-ext.workers.dev/";
  ...
  async function fetchAndDisplayArticle() {
    try {
      ...
      let apiUrl = "https://hs-spotlight-article-en.catalin-avarvarei-ext.workers.dev/";
  ...
  async function fetchCustomAds() {
    try {
      ...
      let apiUrl = "https://hs-custom-ads-en.catalin-avarvarei-ext.workers.dev/";
  ...
  async function fetchBlogPostsLimited() {
    try {
      ...
      const [tagsResponse, postsResponse, authorsMap] = await Promise.all([
        fetchTags(),
        fetch("https://hs-resource-blog-limit-en.avarvareicatalin.workers.dev/"),
  ...
  async function fetchSuccessStoriesLimited() {
    try {
      ...
      let apiUrl = "https://hs-success-stories-limit-en.catalin-avarvarei-ext.workers.dev/";
  ...
  async function fetchWebinarsLimited() {
    try {     
      ...
      const response = await fetch(apiUrl);
      const data = await response.json(); // Moved outside of the if-else structure
